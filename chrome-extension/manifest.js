...
const manifest = deepmerge(
  {
    ...
    description:
      'Your AI-driven interview pal. Easy approach to correct solutions for most LeetCode & Hackerrank problems. All In One Click. Secure your offer with the latest LLM Model, the best interview copilot.',
    permissions: [
